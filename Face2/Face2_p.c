...
typedef struct _Face2_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } Face2_MIDL_TYPE_FORMAT_STRING;

typedef struct _Face2_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } Face2_MIDL_PROC_FORMAT_STRING;

typedef struct _Face2_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } Face2_MIDL_EXPR_FORMAT_STRING;
...
extern const Face2_MIDL_TYPE_FORMAT_STRING Face2__MIDL_TypeFormatString;
extern const Face2_MIDL_PROC_FORMAT_STRING Face2__MIDL_ProcFormatString;
extern const Face2_MIDL_EXPR_FORMAT_STRING Face2__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO ICapturer2_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ICapturer2_ProxyInfo;
...
static const Face2_MIDL_PROC_FORMAT_STRING Face2__MIDL_ProcFormatString =
    {
        0,
        {
...
static const Face2_MIDL_TYPE_FORMAT_STRING Face2__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    Face2__MIDL_ProcFormatString.Format,
...
/* Object interface: ICapturer2, ver. 0.0,
   GUID={0x9625B521,0x6F60,0x49C4,{0x93,0xE0,0x82,0xE7,0x94,0xF4,0xF6,0xFB}} */

#pragma code_seg(".orpc")
static const unsigned short ICapturer2_FormatStringOffsetTable[] =
    {
    210
    };

static const MIDL_STUBLESS_PROXY_INFO ICapturer2_ProxyInfo =
    {
    &Object_StubDesc,
    Face2__MIDL_ProcFormatString.Format,
    &ICapturer2_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ICapturer2_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    Face2__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(4) _ICapturer2ProxyVtbl = 
{
    &ICapturer2_ProxyInfo,
    &IID_ICapturer2,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    (void *) (INT_PTR) -1 /* ICapturer2::Capture */
};

const CInterfaceStubVtbl _ICapturer2StubVtbl =
{
    &IID_ICapturer2,
    &ICapturer2_ServerInfo,
    4,
    0, /* pure interpreted */
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    Face2__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _Face2_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ICapturer2ProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _Face2_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ICapturer2StubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
};

PCInterfaceName const _Face2_InterfaceNamesList[] = 
{
    "ICapturer2",
    "IComponentRegistrar",
    0
...
const IID *  const _Face2_BaseIIDList[] = 
{
    0,
    &IID_IDispatch,
    0
...
#define _Face2_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _Face2, pIID, n)

int __stdcall _Face2_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _Face2, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _Face2, 2, *pIndex )
    
}

const ExtendedProxyFileInfo Face2_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _Face2_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _Face2_StubVtblList,
    (const PCInterfaceName * ) & _Face2_InterfaceNamesList,
    (const IID ** ) & _Face2_BaseIIDList,
    & _Face2_IID_Lookup, 
    2,
    2,
