...
#ifndef __Face2_i_h__
#define __Face2_i_h__
...
#ifndef __ICapturer2_FWD_DEFINED__
#define __ICapturer2_FWD_DEFINED__
typedef interface ICapturer2 ICapturer2;
#endif 	/* __ICapturer2_FWD_DEFINED__ */
...
#ifndef __Capturer2_FWD_DEFINED__
#define __Capturer2_FWD_DEFINED__

#ifdef __cplusplus
typedef class Capturer2 Capturer2;
#else
typedef struct Capturer2 Capturer2;
#endif /* __cplusplus */

#endif 	/* __Capturer2_FWD_DEFINED__ */
...
#ifndef __ICapturer2_INTERFACE_DEFINED__
#define __ICapturer2_INTERFACE_DEFINED__

/* interface ICapturer2 */
/* [unique][uuid][object] */ 


EXTERN_C const IID IID_ICapturer2;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("9625B521-6F60-49C4-93E0-82E794F4F6FB")
    ICapturer2 : public IUnknown
    {
    public:
    ...
    interface ICapturer2
    {
        CONST_VTBL struct ICapturer2Vtbl *lpVtbl;
    };
...
#define ICapturer2_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ICapturer2_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ICapturer2_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ICapturer2_Capture(This,id)	\
    ( (This)->lpVtbl -> Capture(This,id) ) 
...
#endif 	/* __ICapturer2_INTERFACE_DEFINED__ */



#ifndef __Face2Lib_LIBRARY_DEFINED__
#define __Face2Lib_LIBRARY_DEFINED__

/* library Face2Lib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_Face2Lib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("FCB6F471-A764-4E98-8EA7-0BC2537457A6")
CompReg;
#endif

EXTERN_C const CLSID CLSID_Capturer2;

#ifdef __cplusplus

class DECLSPEC_UUID("C5FBC281-361A-4F0A-9EE8-1A581D937634")
Capturer2;
#endif
#endif /* __Face2Lib_LIBRARY_DEFINED__ */
